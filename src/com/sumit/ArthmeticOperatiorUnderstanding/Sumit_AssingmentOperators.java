package com.sumit.ArthmeticOperatiorUnderstanding;

public class Sumit_AssingmentOperators 
{
	//Normal Assignment
	...
	static String name = "Sumit"; // name variable gets the value ToolsQA
	...
	//	speed = "Sumit"; //String can not be assign to integer
	//	name = 10; // Integer can not be assign to String
	//	isGood = "sumit" // String can not be assign to Boolean
		}
	}